...
class PoseNetFeatGlobal(nn.Module):
    def __init__(self, num_points):
        super(PoseNetFeatGlobal, self).__init__()
...
class PoseNetGlobal(nn.Module):
    def __init__(self, num_points, num_obj):
        ...
        # Note that feat is only the global feature ap_x now 
        self.feat = PoseNetFeatGlobal(num_points)
