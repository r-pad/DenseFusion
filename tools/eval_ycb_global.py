...
from lib.network_global import PoseNetGlobal, PoseRefineNet
...
estimator = PoseNetGlobal(num_points = num_points, num_obj = num_obj)
estimator.cuda()
...
for now in range(0, testlist_size):
