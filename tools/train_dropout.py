...
from lib.network import PoseNetDropout, PoseRefineNet
...
def main():
    ...
    if opt.dataset == 'ycb':
        ...
        opt.outf = 'trained_models/ycb_dropout' #folder to save trained models
        opt.log_dir = 'experiments/logs/ycb_dropout' #folder to save logs
    ...
    estimator = PoseNetDropout(num_points = opt.num_points, num_obj = opt.num_objects)
    estimator.cuda()
